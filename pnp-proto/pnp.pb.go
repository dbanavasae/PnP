...
const (
	ClientPlatformMsgType_SDP_PLATFORM_MASTER_INIT               ClientPlatformMsgType = 0
	ClientPlatformMsgType_SDP_PLATFORM_SATELLITE_INIT            ClientPlatformMsgType = 1
	ClientPlatformMsgType_SDP_PLATFORM_ALREADY_INSTALLED         ClientPlatformMsgType = 2
	ClientPlatformMsgType_SDP_PLATFORM_NOT_INSTALLED             ClientPlatformMsgType = 3
	ClientPlatformMsgType_SDP_PLATFORM_ARTIFACT_DOWNLOAD_SUCCESS ClientPlatformMsgType = 4
	ClientPlatformMsgType_SDP_PLATFORM_ARTIFACT_DOWNLOAD_FAILED  ClientPlatformMsgType = 5
	ClientPlatformMsgType_SDP_PLATFORM_DEPLOYMENT_SUCCESS        ClientPlatformMsgType = 6
	ClientPlatformMsgType_SDP_PLATFORM_DEPLOYMENT_FAILED         ClientPlatformMsgType = 7
	ClientPlatformMsgType_SDP_PLATFORM_SERVICE_UP                ClientPlatformMsgType = 8
	ClientPlatformMsgType_SDP_PLATFORM_SERVICE_DOWN              ClientPlatformMsgType = 9
)

var ClientPlatformMsgType_name = map[int32]string{
	0: "SDP_PLATFORM_MASTER_INIT",
	1: "SDP_PLATFORM_SATELLITE_INIT",
	2: "SDP_PLATFORM_ALREADY_INSTALLED",
	3: "SDP_PLATFORM_NOT_INSTALLED",
	4: "SDP_PLATFORM_ARTIFACT_DOWNLOAD_SUCCESS",
	5: "SDP_PLATFORM_ARTIFACT_DOWNLOAD_FAILED",
	6: "SDP_PLATFORM_DEPLOYMENT_SUCCESS",
	7: "SDP_PLATFORM_DEPLOYMENT_FAILED",
	8: "SDP_PLATFORM_SERVICE_UP",
	9: "SDP_PLATFORM_SERVICE_DOWN",
}
...
const (
	SDPOperType_IS_SDP_PLATFORM_INSTALLED      SDPOperType = 0
	SDPOperType_DOWNLOAD_SDP_PLATFORM_ARTIFACT SDPOperType = 1
	SDPOperType_DEPLOY_SDP_PLATFORM            SDPOperType = 2
	SDPOperType_CHECK_SDP_PLATFORM_STATUS      SDPOperType = 3
)

var SDPOperType_name = map[int32]string{
	0: "IS_SDP_PLATFORM_INSTALLED",
	1: "DOWNLOAD_SDP_PLATFORM_ARTIFACT",
	2: "DEPLOY_SDP_PLATFORM",
	3: "CHECK_SDP_PLATFORM_STATUS",
}
...
type SDPDeploymentType int32

const (
	SDPDeploymentType_MASTER    SDPDeploymentType = 0
	SDPDeploymentType_SATELLITE SDPDeploymentType = 1
)

var SDPDeploymentType_name = map[int32]string{
	0: "MASTER",
	1: "SATELLITE",
}
var SDPDeploymentType_value = map[string]int32{
	"MASTER":    0,
	"SATELLITE": 1,
}

func (x SDPDeploymentType) String() string {
	return proto.EnumName(SDPDeploymentType_name, int32(x))
}
func (SDPDeploymentType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (m *ClientPlatformMsg) GetClientPlatformMsgType() ClientPlatformMsgType {
	...
	return ClientPlatformMsgType_SDP_PLATFORM_MASTER_INIT
}
...
type ServerPlatformResponse struct {
	...
	SdpDeploymentType    SDPDeploymentType     `protobuf:"varint,3,opt,name=sdpDeploymentType,enum=pnp.SDPDeploymentType" json:"sdpDeploymentType,omitempty"`
	InstructionPayload   *InstructionPayload   `protobuf:"bytes,4,opt,name=instructionPayload" json:"instructionPayload,omitempty"`
}
...
func (m *ServerPlatformResponse) GetSdpOperType() SDPOperType {
	...
	return SDPOperType_IS_SDP_PLATFORM_INSTALLED
}

func (m *ServerPlatformResponse) GetSdpDeploymentType() SDPDeploymentType {
	if m != nil {
		return m.SdpDeploymentType
	}
	return SDPDeploymentType_MASTER
}
...
func init() {
	...
	proto.RegisterEnum("pnp.SDPDeploymentType", SDPDeploymentType_name, SDPDeploymentType_value)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
